...
public class ToyDonorAdapter extends FirebaseRecyclerAdapter<
        Toy, ToyDonorAdapter.toysViewholder> {
    DatabaseReference mbase;
    public ToyDonorAdapter(
    ...
    @NonNull
    @Override
    public ToyDonorAdapter.toysViewholder
    onCreateViewHolder(@NonNull ViewGroup parent,
                       int viewType)
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.toy, parent, false);
        return new ToyDonorAdapter.toysViewholder(view);
    }
    @Override
    protected void onBindViewHolder(@NonNull ToyDonorAdapter.toysViewholder holder, int position, @NonNull Toy model) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), ShowToyDonorActivity.class);
