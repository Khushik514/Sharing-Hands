...
public class ToyPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toy_posts);
        ...
        FirebaseRecyclerOptions<Toy> options
                ...
                .setQuery(mbase, Toy.class)
                .build();
        adapter = new ToyAdapter(options);
