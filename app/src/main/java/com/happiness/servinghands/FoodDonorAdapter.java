...
public class FoodDonorAdapter extends FirebaseRecyclerAdapter<
        Food, FoodDonorAdapter.foodsViewholder> {
    DatabaseReference mbase;
    public FoodDonorAdapter(
    ...
    @NonNull
    @Override
    public FoodDonorAdapter.foodsViewholder
    onCreateViewHolder(@NonNull ViewGroup parent,
                       int viewType)
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.food, parent, false);
        return new FoodDonorAdapter.foodsViewholder(view);
    }
    @Override
    protected void onBindViewHolder(@NonNull FoodDonorAdapter.foodsViewholder holder, int position, @NonNull Food model) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), ShowFoodDonorActivity.class);
